...
# TODO: reset point values to 0
TOP_LEFT: NDArray[np.float64] = np.array([51.6696875, 48.70765625, 19.687559])
BOTTOM_RIGHT: NDArray[np.float64] = np.array([55.06625, 44.0253125, 19.687559])
...
def check_user_specified_params() -> None:
    """
    Verify that user-specified const values are valid and provide feedback for configuration
    """
